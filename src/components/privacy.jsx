...
const Privacy = () => {
  return (
    <div className="privacy-policy max-w-5xl mx-auto p-5 bg-white text-black leading-relaxed font-sans">
      <h1 className="text-3xl font-bold mb-4">Manini Pay Hybrid Payment Platform Privacy Policy</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">4. Disclosure of Information</h2>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">5. Automated Decision-Making</h2>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">10. Policy Updates</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">PART A: AUSTRALIAN PRIVACY COMPLIANCE</h2>

      <h3 className="text-xl font-semibold mt-4 mb-2">1. Legal Framework</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">2. Jurisdiction</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">3. Disclosure of Personal Information</h3>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">4. Cross-Border Data Transfers</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">5. Credit-Related Personal Information</h3>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">6. Access & Correction Rights</h3>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">7. Complaints Resolution</h3>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">PART B: GENERAL PRIVACY POLICY</h2>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">1. Types of Data We Collect and Lawful Bases for Processing</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">2. How We Use and Share Your Data</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">3. Data Retention</h3>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">4. Automated Decision-Making</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">5. User Rights</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">6. International Data Transfers</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">7. Data Security</h3>
      <p>We implement robust measures such as encryption and access controls. Report suspected breaches immediately.</p>

      <h3 className="text-xl font-semibold mt-4 mb-2">8. Children's Privacy</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">9. Complaints and Oversight</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">10. Changes to This Policy</h3>
      ...
      <h3 className="text-xl font-semibold mt-4 mb-2">Contact Manini Pay</h3>
      <ul className="list-disc ml-5 space-y-1">
      ...
      <p className="mt-6">© 2025 Manini Pay Pty Ltd (ABN 28 650 149 205). All rights reserved. Effective Date: August 25, 2025.</p>
    </div>
  );
};
